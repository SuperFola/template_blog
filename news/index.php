    ...
    <body>
        ...
        if (isset($_POST['titre']) and isset($_POST['contentHTML']) and $_POST['titre'] != '' and $_POST['contentHTML'] != ''
            ...
            if ($access_granted){
                ...
                fputs($nouvelle_news, "<li><a href=\"#\" onclick=\"s('" . $news_number . "')\">[" . $_POST['categorie'] .  "] - " . $_POST['titre'] . " " . date("d/m/y") . "</a></li>\n");
        ...
        <form method="post" action="index.php">
            ...
            <div id="completeEditeur">
                ...
                <div id="html_editeur">
                    ...
                    <input type="button" onclick="refresh_html();" value="Raffraichir" id="btn_html_refresh"><br />
