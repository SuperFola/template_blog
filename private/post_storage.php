<?php
    ...
    class PostManager {
        ...
        /**
         * Retourne une array de tous les posts par ordre chronologique ou chronologique inversé
         *
         * @param $order
         * @return array
         */
        public function findAll($order = 'ASC') {
            ...
            if ('ASC') {
                // Si on veut les posts par ordre chronologique
                return array_values($posts);
            } else {
                // Si on veut les posts par ordre chronologique inversé
